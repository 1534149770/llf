...
<html>
	<head>
		...
		<script type="text/javascript">
	    	// 看不清，换一张
	  	  	function img(obj){
	    		obj.src = "${pageContext.request.contextPath }/Admin/img.do?suiyi="+Math.random();
	   		 }
	   		 $(function(){
	   		 	$("#loginBtn").linkbutton({
	   		 		onClick:function(){
	...
	<body>
		<div class="login">
			<form id="loginForm" method="post" action="${pageContext.request.contextPath }/Admin/login.do">
				<table>
						<tbody>
							<tr>
						  ...
						  <tr>
							...
							<tr>
								...
								<td>
									...
									<img id="captchaImage" onclick="img(this)" src="${pageContext.request.contextPath }/Admin/img.do" title="点击更换验证码"/>
								</td>
							</tr>					
						<tr>
							<td>
